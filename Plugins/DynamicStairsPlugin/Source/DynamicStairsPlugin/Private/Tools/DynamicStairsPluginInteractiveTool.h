...
#include "DynamicStairsPluginInteractiveTool.generated.h"


/**
 * Builder for UDynamicStairsPluginInteractiveTool
 */
UCLASS()
class DYNAMICSTAIRSPLUGIN_API UDynamicStairsPluginInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
 ...
 */
UCLASS(Transient)
class DYNAMICSTAIRSPLUGIN_API UDynamicStairsPluginInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UDynamicStairsPluginInteractiveToolProperties();
 ...
 */
UCLASS()
class DYNAMICSTAIRSPLUGIN_API UDynamicStairsPluginInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UDynamicStairsPluginInteractiveToolProperties> Properties;
