...
#include "DynamicStairsPluginEditorMode.generated.h"
 ...
 */
UCLASS()
class UDynamicStairsPluginEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_DynamicStairsPluginEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;
	static FString MyStairsToolName;

	UDynamicStairsPluginEditorMode();
	virtual ~UDynamicStairsPluginEditorMode();
